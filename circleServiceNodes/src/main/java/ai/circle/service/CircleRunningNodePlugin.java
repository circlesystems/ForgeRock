...
public class CircleRunningNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(CircleRunningNodePlugin.currentVersion,
                Collections.singletonList(CircleRunningNode.class));
    }
    ...
    public String getPluginVersion() {
        return CircleRunningNodePlugin.currentVersion;
    }
}
