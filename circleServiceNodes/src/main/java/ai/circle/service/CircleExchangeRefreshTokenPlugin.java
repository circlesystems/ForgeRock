...
public class CircleExchangeRefreshTokenPlugin extends AbstractNodeAmPlugin {

    static private String currentVersion = "1.0.0";

    /**
     * Specify the Map of list of node classes that the plugin is providing. These
     * will then be installed and registered at the appropriate times in plugin
     * lifecycle.
     *
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(CircleExchangeRefreshTokenPlugin.currentVersion,
                Collections.singletonList(CircleExchangeRefreshToken.class));
    }
    ...
    public String getPluginVersion() {
        return CircleExchangeRefreshTokenPlugin.currentVersion;
    }
}
