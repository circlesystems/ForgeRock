...
public class CircleUnlockUserNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(CircleUnlockUserNodePlugin.currentVersion,
                Collections.singletonList(CircleUnlockUserNode.class));
    }
    ...
    public String getPluginVersion() {
        return CircleUnlockUserNodePlugin.currentVersion;
    }
}
