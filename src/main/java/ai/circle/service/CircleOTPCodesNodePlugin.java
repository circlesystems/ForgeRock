...
public class CircleOTPCodesNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(CircleOTPCodesNodePlugin.currentVersion,
                Collections.singletonList(CircleOTPCodesNode.class));
    }
    ...
    public String getPluginVersion() {
        return CircleOTPCodesNodePlugin.currentVersion;
    }
}
