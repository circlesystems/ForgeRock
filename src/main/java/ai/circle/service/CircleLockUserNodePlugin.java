...
public class CircleLockUserNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(CircleLockUserNodePlugin.currentVersion,
                Collections.singletonList(CircleLockUserNode.class));
    }
    ...
    public String getPluginVersion() {
        return CircleLockUserNodePlugin.currentVersion;
    }
}
