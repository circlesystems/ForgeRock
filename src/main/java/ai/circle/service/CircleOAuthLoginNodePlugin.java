...
public class CircleOAuthLoginNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(CircleOAuthLoginNodePlugin.currentVersion,
                Collections.singletonList(CircleOAuthLoginNode.class));
    }
    ...
    public String getPluginVersion() {
        return CircleOAuthLoginNodePlugin.currentVersion;
    }
}
